	 ...
	 private Collector<Crime, CrimeJSON> collector;
	    ...
	    public void testMethodForMungeeNullObjectCompare() throws Exception {
	        ...
	        List<Crime> expectedList = Lists.newArrayList(
	        		  ...
	        		  new Crime(0, "HZ229112", "2015-03-15", "SIMPLE", "016", 0, "08B", 10488624, "PARKING", "CRMINAL DAMAGE", "2016-04-12", 2016),
	        		  new Crime(1, "EZ239102", "2014-01-11", "MUGGING", "025", 1, "01Z", 10596626, "GARAGE", "THREAT", "2015-04-12", 2014),
	        		  new Crime(0, "YP225782", "2013-02-12", "MAJOR CRIME", "305", 0, "18B", 10493624, "NEAR COLLAGE", "THEFT", "2015-10-12", 2013)
	        );
	    ...
	    public void testMethodForMungeeDataTransformationForArrest() throws Exception {
	    	...
	    	List<Crime> list = (List<Crime>) collector.mungee( Lists.newArrayList(
	    			 new CrimeJSON("false", "0131", "0123 S STATE ST", "HZ229112", "33",  "04/15/2016 12:50:00 PM", "SIMPLE", "016", "false", "08B", "10488624", "1320", "42.825359953", "CTA PLATFORM", "-87.456778", "CRMINAL DAMAGE",  "04/12/2016 05:15:00 PM", "17", "1152973", "1894914", "2016")
			        )); 
	    ...
	    public void testMethodForMungeeDataTransformationForDomestic() throws Exception {
	    	...
	    	List<Crime> list = (List<Crime>) collector.mungee( Lists.newArrayList(
	    			 new CrimeJSON("false", "0131", "0123 S STATE ST", "HZ229112", "33",  "04/15/2016 12:50:00 PM", "SIMPLE", "016", "true", "08B", "10488624", "1320", "42.825359953", "CTA PLATFORM", "-87.456778", "CRMINAL DAMAGE",  "04/12/2016 05:15:00 PM", "17", "1152973", "1894914", "2016")
			        ));     
